...
const galleryImages: GalleryImage[] = [
  {
    id: 1,
    src: "/gallery-nail-art-1.jpg",
    alt: "Luxury nail art",
    category: "Nails",
  },
  {
    id: 2,
    src: "/gallery-lash-extensions.jpg",
    alt: "Lash extensions",
    category: "Lashes",
  },
  {
    id: 3,
    src: "/gallery-makeup-artistry.jpg",
    alt: "Professional makeup",
    category: "Makeup",
  },
  {
    id: 4,
    src: "/gallery-nail-design-gems.jpg",
    alt: "Elegant nails",
    category: "Nails",
  },
  {
    id: 5,
    src: "/gallery-eye-makeup.jpg",
    alt: "Glamorous makeup",
    category: "Makeup",
  },
  {
    id: 6,
    src: "/gallery-spa-treatment.jpg",
...
export function InteractiveGallery() {
  ...
  const categories = ["All", "Nails", "Lashes", "Makeup", "Spa"]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollAnimation>
          <div className="text-center mb-16">
            ...
            <h2 className="luxury-text text-5xl md:text-6xl mb-6">Our Artistry in Motion</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Explore our portfolio of transformations and beauty masterpieces.
            </p>
          </div>
        </ScrollAnimation>
