...
export default function ServicesPage() {
  ...
  const testimonials = [
    ...
    {
      text: "L'Atelier Beauty Lounge's makeup artistry boosted my confidence for a special occasion. Impeccable and long-lasting.",
      author: "Omar B.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center space-y-6">
            ...
            <h1 className="luxury-text md:text-6xl leading-tight text-white text-3xl lg:text-6xl">
              Elevate Your Style
              <span className="block text-chart-5">with L'Atelier Beauty Lounge</span>
            </h1>
              ...
              >
                ...
                <div className="space-y-6 text-center">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pt-4">
                    ...
                    <Link
                      href="/booking"
                      className="px-6 py-3 bg-[#f9b215] text-black rounded-full font-semibold hover:bg-[#f0a80d] transition-all flex md:inline-flex items-center gap-2 group w-full md:w-auto justify-center md:justify-start"
                    >
                      Book Service
      ...
      <section className="py-20 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Discover heartfelt reviews from our clients who love their transformed looks and the confidence L'Atelier
      ...
      <section className="py-20 md:py-32 text-primary-foreground bg-chart-2">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
            Book your appointment today and experience the L'Atelier Beauty Lounge difference.
          </p>
          <Link
            href="/booking"
            className="flex md:inline-flex items-center gap-2 px-8 py-3 bg-[#f9b215] rounded-full font-semibold hover:shadow-lg transition-all hover:scale-105 w-full md:w-auto justify-center text-foreground bg-card"
          >
            Book Now
            <span>→</span>
          </Link>
